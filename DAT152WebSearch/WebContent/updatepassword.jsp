...
<form name="updatePasswordForm" action=updatepassword method="post" onsubmit="return validateForm()">
    ...
    <table>
        <tr>
            ...
            <td><input type="password" name="passwordnew" placeholder="new password"/></td>
        </tr>
        <tr>
            <td><p>Confirm New Password</td>
            <td><input type="password" name="confirm_passwordnew" placeholder="confirm new password"/></td>
        </tr>
        <tr>
